...
const char* MQTT_BROKER  = "134.169.115.164"; //your Ubuntu machine IP
...
const unsigned long RED_YELLOW_INTERVAL = 2000; // 2 seconds
const unsigned long GREEN_INTERVAL = 5000;  // 5 seconds
...
void loop() {
  ...
  switch (currentState) {
    case RED: interval = RED_INTERVAL; break;
    case RED_YELLOW: interval = RED_YELLOW_INTERVAL; break;
    case GREEN: interval = GREEN_INTERVAL; break;
    case YELLOW: interval = YELLOW_INTERVAL; break;
  }
